# Generated by Django 3.1.2 on 2020-11-15 11:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.parameter', verbose_name='')),
                ('product_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.productinfo', verbose_name='')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='category',
            name='shops',
            field=models.ManyToManyField(to='shop.Shop', verbose_name='Магазины'),
        ),
    ]
